...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'fastvideo' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'fastvideo' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'fastvideo' ),
		'cyrillic'     => __( 'Cyrillic', 'fastvideo' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'fastvideo' ),
		'devanagari'   => __( 'Devanagari', 'fastvideo' ),
		'greek'        => __( 'Greek', 'fastvideo' ),
		'greek-ext'    => __( 'Greek Extended', 'fastvideo' ),
		'khmer'        => __( 'Khmer', 'fastvideo' ),
		'latin'        => __( 'Latin', 'fastvideo' ),
		'latin-ext'    => __( 'Latin Extended', 'fastvideo' ),
		'vietnamese'   => __( 'Vietnamese', 'fastvideo' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'fastvideo' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'fastvideo' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'fastvideo' ),
